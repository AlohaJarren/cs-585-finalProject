...
Experimentally, when using our chosen canidates we have found that the size of $\mathbf{K}$ ceases to drop in size after approximately 20 ciphertext pairs have been processed. This takes approximately 100 initial plaintext pairs, making a total of 1600 encryptions across all 8 S-boxes. 
